  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange} title="Entrada de diario">
      <div className="flex flex-col gap-4">
        <TextAreaField label="¿Qué agradeces hoy?" rows={2} value={gratitude} onChange={(e) => setGratitude(e.target.value)} autoFocus />
        <TextAreaField label="¿Qué aprendiste hoy?" rows={2} value={learned} onChange={(e) => setLearned(e.target.value)} />
        <div>
